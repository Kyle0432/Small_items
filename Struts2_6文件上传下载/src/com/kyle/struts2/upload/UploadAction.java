package com.kyle.struts2.upload;
...
public class UploadAction extends ActionSupport {
	...
	private List<String> pptContextType;
	...
	public List<String> getPptContextType() {
		return pptContextType;
	}

	public void setPptContextType(List<String> pptContextType) {
	...
	public String execute() throws Exception {
        ...
        System.out.println(pptContextType);
